...
-- 2. Applications.
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd(fileManager), { description = "Opens the file manager" })
hl.bind(mainMod .. " + C", hl.dsp.exec_cmd(code), { description = "Opens the text editor" })
hl.bind(mainMod .. "+ RETURN", hl.dsp.exec_cmd(terminal), { description = "Opens the terminal" })
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd(browser), { description = "Opens the browser" })

-- 3. Noctalia panels.
hl.bind(mainModShift .. " + RETURN", hl.dsp.exec_cmd(menu), { description = "Opens the app launcher" })
hl.bind(mainModShift .. " + V", hl.dsp.exec_cmd(clipboard), { description = "Opens the clipboard" })
hl.bind(mainModShift .. " + ESCAPE", hl.dsp.exec_cmd(power_menu), { description = "Opens the power menu" })
hl.bind(
	mainModShift .. "+ SLASH",
